        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ url('/languages/create') }}" class="btn btn-success btn-sm" title="Add New Language">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Name</th><th>Extension</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($languages as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->name }}</td><td>{{ $item->extension }}</td>
                                        <td>
                                            <a href="{{ url('/languages/' . $item->id) }}" title="View Language"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/languages/' . $item->id . '/edit') }}" title="Edit Language"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
